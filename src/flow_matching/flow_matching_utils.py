...
def sample_discrete_features(probX, probE, node_mask, mask=False, thr=1):
    ...
    probE_max, probE_argmax = probE.max(dim=-1)
    probE_mask = probE_max > thr
    E_t[probE_mask, :] = probE_argmax[probE_mask].unsqueeze(-1)
